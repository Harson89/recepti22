...
$_SESSION['recept_za_urediti'] = $_GET['uredi_id'];
...
$novinaziv = $_POST['nazivrecepta'];
$novapriprema = $_POST['priprema'];
...
<div id="form-outer">
  ...
  <form id="survey-form" action="edit_recepata_PRAVI.php" method="POST">
        <div class="rowTab">
